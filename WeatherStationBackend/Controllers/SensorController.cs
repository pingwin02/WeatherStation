...
namespace WeatherStationBackend.Controllers
{
    ...
    public class SensorController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="sensorService">The service responsible for managing sensors.</param>
        /// <param name="dataService">The service responsible for managing sensor data.</param>
